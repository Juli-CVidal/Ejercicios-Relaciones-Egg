...
public class Constantes {
    public static final String OPCIONES_DISPONIBLES = "\n1.Barajar \n"
            + "2.Obtener una carta \n"
    ...
    public static final String PEDIR_OPCION = "¿Qué quiere hacer? ";
    ...
    public static final String MOSTRAR_CANTIDAD_DISPONIBLES(long cantidad){
    ...
    public static final String MOSTRAR_CARTAS_DISPONIBLES = "Las cartas que se encuentran en la baraja son: ";
    public static final String MOSTRAR_CARTAS_USADAS = "Las cartas que se encuentran en el montón son: ";
}